...
class Tan_Test {
	...
	public void radCartesianBoundryTestWithZero() {
		...
		Assert.assertEquals(0.0,Tan.calculate(radian),0.00001);
	}
	...
	public void degTestPositiveAngleGreaterthan360() {
		...
		Assert.assertEquals(1.0,Tan.calculate(radian),0.00001);
	}
	...
	public void degAsymptoteTest90() {
		...
		Assertions.assertThrows(ArithmeticException.class, () -> Tan.calculate(radian));
	}
