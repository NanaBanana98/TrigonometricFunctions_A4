		...
		class RadianBoundryTest{
			...
			class PostiveRadianBoundryTest{
				...
				public void TestWithZero() {
					...
					Assert.assertEquals(0.0,Tan_FinalVersion.calculate(radian),0.000001);
				}
				...
				public void JustAboveTestWithZero() {
					...
					Assert.assertEquals(0.100335,Tan_FinalVersion.calculate(radian),0.000001);
				}
				
				@Test
				public void JustAboveTestWithHalfPI() {
					IAngleMeasurement radian = new RadianMeasurement(Maths.PI/2+0.1);
					Assert.assertEquals(-7.371660,Tan_FinalVersion.calculate(radian),0.000001);
				}
		...
		class DegreeBoundryTest{
			...
			class PostiveRadianBoundryTest{
				...
				public void JustAboveTestWith90() {
					...
					Assert.assertEquals(-12.909791,Tan_FinalVersion.calculate(radian),0.000001);
				}
				
				@Test
				public void JustAboveTestWith180() {
					IAngleMeasurement radian = new DegreeMeasurement(180.1);
					Assert.assertEquals(0.001745,Tan_FinalVersion.calculate(radian),0.000001);
				}
	...
	class OutOf360Test{
		...
		class RadianOutOf360Test{
			...
			public void TestGreaterthan2PI() {
				...
				Assert.assertEquals(1.0,Tan_FinalVersion.calculate(radian),0.000001);
			}
